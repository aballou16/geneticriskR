...
For this vignette, we will be using the mock data included in this package (pheno_data and score_data). It is important to note that the values for score and phenotype were randomly generated, so they do not appear to be very predictive. 
...
**Step 5. Perform analyses on full_table to assess the predictive power of the scores. In this example, we will use a simple logistc regression model using simple_logistic_reg() and examine the area under the curve using proc_analysis()**
...
*Note: Important things to consider from these analyses:*
...
- **pheno_select()** *selects phenotype of interest from the large phenotype file*
